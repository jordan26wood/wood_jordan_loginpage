...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 16, 2018 at 04:44 PM
...
CREATE TABLE IF NOT EXISTS `tbl_user` (
  ...
  `user_prevLogin` varchar(100) NOT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_ip`, `user_prevLogin`) VALUES
(1, 'Jordan', 'jordanwood', 'fanshawe', 'jordan@gmail.com', '2018-02-14 01:00:12', '::1', '2018-02-16 01:16:32');
COMMIT;
